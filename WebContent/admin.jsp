...
<body
	onload="first_function('<%= request.getParameter("cid") %>');do_posti();">
	...
	<div class="container-narrow">
		...
		<h4>Position [UNDERGROUND - 7]</h4>
		<div align="center">
			<div id="chart1" style="width: 480px; height: 250px;"></div>
		</div>

		<br />
		<h4>Expected Earnings</h4>
		<div align="center">
			<div id="chart2" style="width: 480px; height: 250px;"></div>
		</div>
