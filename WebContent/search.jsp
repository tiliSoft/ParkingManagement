...
<body onload="first_function('<%= request.getParameter("cid") %>');">
	...
	<div class="container-narrow">
					...
					<ul class="dropdown-menu">
						...
						<li><a onclick="new_contract_extra(0);"
							href="javascript:void(null);"><i class="icon-file"></i>&nbsp;<b>New</b>
								Registration</a></li>
						<li><a onclick="lista_completta();"
							href="javascript:void(null);"><i class="icon-align-justify"></i>&nbsp;Total Customers</a></li>
		...
		<div align="center">
			<form class="form-search" id="form-search" name="form-search"
				action="" method="post">

				<input onkeyup='call_autocomplete();' name="query" id="query"
					type="text" class="input-xxlarge" placeholder="Search: Name, license plate, Post">
				<div>
