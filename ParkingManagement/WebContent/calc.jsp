...
<script type="text/javascript" src="js/calc_myjs.js"></script>
...
<body
	onload="first_function('<%= request.getParameter("cid") %>');init_calc();">
	...
	<div class="container-narrow">
		...
		<h4>
			Calculation <u> Wish </ u> Income
		</h4>
		<div align="center">
			<div class="row">
				<div class="span1"></div>
				<div align="right" class="span2">Income desired:</div>
				<div class="span2">
					<input name="top" id="top" type="text" class="input-small">
				</div>
				<div align="left" class="span2" id="kathara_top"></div>
			</div>
			<div class="row">
				<div class="span1"></div>
				<div align="right" class="span2">Average Rent:</div>
				<div class="span2">
					<input name="media" id="media" type="text" class="input-small">
				</div>
				<div align="left" class="span2" id="kathara_media"></div>
			</div>
			<div class="row">
				<div class="span1"></div>
				<div class="span2"></div>
				<div class="span2">
					<button class="btn " onclick="get_value_from_server();">
						<i class="icon-refresh"></i>&nbsp;Calculate
					</button>
				</div>
				<div class="span2"></div>
			</div>
			<div id="chart_calc" style="width: 480px; height: 250px;"></div>
			<div id="chart_calc_msg" class="Zs" style='display: none'></div>
		</div>
