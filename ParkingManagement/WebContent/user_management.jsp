...
<script type="text/javascript" src="js/admin_myjs.js"></script>
</head>

<body
	onload="first_function('<%= request.getParameter("cid") %>');get_lista(13);">
	...
	<div class="masthead">
		...
		<div class="row-fluid">
			...
			<div id="con_gridbox_list" class="span10 offset1">
				<div id="gridbox_list"
					style="width: 100%; height: 350px; background-color: white;"></div>
				<div align="center">
					<a href="javascript:void(null);" onclick="export_this_list();"><img
						src="img/excel.gif"></img>Download Excel</a> &nbsp; | &nbsp; <a
						href="javascript:void(null);" onclick="saveRows_users();"><img
						src="img/save.png">Save</a> &nbsp; <span id="msgbox_save"></span>
				</div>
				<div align="left">
					Total: <b><span id="tot_grid"></span></b>
				</div>
			</div>
		</div>
	...
	<script src="js/user_management_myjs.js"></script>
