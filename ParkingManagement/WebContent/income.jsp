...
<link href="framework_dhtmlx/dhtmlxChart/codebase/dhtmlxchart.css"
	rel="stylesheet" type="text/css" />
<script type="text/javascript" src="js/income_myjs.js"></script>
<script type="text/javascript"
	src="framework_dhtmlx/dhtmlxChart/common/testdata.js"></script>
...
.Zs {
	...
	color: rgb(0, 0, 0);
	font-size: 95%;
	border: 1px solid rgb(10, 179, 44);
}
</style>
...
<body
	onload="first_function('<%= request.getParameter("cid") %>');doOnLoad_real();">
	...
	<div class="container-narrow">
		...
		<h4>Calculation of Income</h4>
		<div align="center">

			<div class="row">
				<div class="span1"></div>
				<div align="right" class="span2">From:</div>
				<div class="span2">
					<input type="text" id="date_from"
						onclick="setSens('date_to', 'max');" class="input-small">
				</div>
			</div>
			<div class="row">
				<div class="span1"></div>
				<div align="right" class="span2">To:</div>
				<div class="span2">
					<input type="text" id="date_to"
						onclick="setSens('date_from', 'min');" class="input-small">
				</div>
			</div>
			<div class="row">
				<div class="span1"></div>
				<div class="span2"></div>
				<div class="span2">
					<button class="btn " onclick="pre_get_and_render();">
						<i class="icon-refresh"></i>&nbsp;Calculate
					</button>
				</div>
			</div>

			<div id="chart_calc2_3" style="width: 100%; height: 250px;"></div>
			<div align="left" class="Zs" id="totale_3"></div>
			<hr>
			<div id="chart_calc2_2" style="width: 100%; height: 250px;"></div>
			<div class="Zs">
				<div align="left" id="totale_2"></div>
				<div align="left" id="totale_1"></div>
			</div>
		</div>
	...
	<script type="text/javascript"
		src="framework_dhtmlx/dhtmlxChart/codebase/dhtmlxchart.js"></script>
