...
<body
	onload="first_function('<%= request.getParameter("cid") %>');get_all_sessions(<%= request.getParameter("code") %>);">
	...
	<script type="text/javascript" src="js/show_log_myjs.js"></script>
